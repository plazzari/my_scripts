...
mediterranean_bounds = {
    ...
    "lon_min": -10.0, # Limite inferiore della longitudine
...
sc = plt.scatter(
    data[longitude_col],
    data[latitude_col],
    c=data[chlorophyll_col],
    cmap="viridis",
    norm=mcolors.LogNorm(vmin=data[chlorophyll_col].min(), vmax=data[chlorophyll_col].max()),  # Scala logaritmica
...
plt.title("Distribuzione della Clorofilla nel Mediterraneo (Punti Singoli)")
plt.xlabel("Longitudine")
plt.ylabel("Latitudine")

# Salva la figura in formato PNG
output_file = "/g100/home/userexternal/plazzari/my_scripts/MedBGCins/scatter_plot_mediterranean_log.png"
