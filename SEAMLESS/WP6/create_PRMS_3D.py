...
var="PRMS.Z5.p_sum"
PARAMETER_DIR="/g100_work/OGS_devC/V10C/RUNS_SETUP/SEAMLESS/eat_da_pseudo_lagrangian_T15/PLOTS/PARAMETERS_TXT/"
...
for my_date in date_list:
    ...
    for isub, sub in enumerate(SUBlist):
       ...
       if str(sub) in float2sub:
          ...
          for floatname in float2sub[str(sub)]:
              filein=PARAMETER_DIR+floatname+"_instances_Z5_parameters_p_sum_interp.txt"
    ...
    filenc="/g100_scratch/userexternal/plazzari/RST." + yyyymmdd + "-00:00:00." + var + ".nc"
